...
class KBS_Welcome {
	...
	public function tabs(){
		...
		<h2 class="nav-tab-wrapper wp-clearfix">
			<a href="<?php echo $get_started_url; ?>"
			   class="nav-tab <?php echo $selected == 'kbs-getting-started' ? 'nav-tab-active' : ''; ?>">
				<?php _e( 'Getting Started', 'kb-support' ); ?>
			</a>
			<a href="<?php echo $about_url; ?>"
			   class="nav-tab <?php echo $selected == 'kbs-about' ? 'nav-tab-active' : ''; ?>">
	...
	public function about_screen(){
		...
		<div class="wrap row wpchill-about-row wp-clearfix">
			<div class="wpchill-about__container">
				...
				<div class="feature-section wp-clearfix introduction flex">
					...
					<div class="video feature-section-item">
						<img
							src="<?php echo KBS_PLUGIN_URL . '/assets/images/screenshots/11-sequential-ticket-settings.png' ?>"
							alt="<?php printf( __( 'Sequential %s', 'kb-support' ), $this->ticket_plural ); ?>">
					</div>
					...
					<div class="content feature-section-item last-feature">
						...
						<a href="https://kb-support.com/articles/enabling-sequential-ticket-numbers/" target="_blank"
				...
				<div class="feature-section wp-clearfix flex">
					...
					<div class="content feature-section-item">
						...
						<a href="https://kb-support.com/articles/assigning-multiple-agents-ticket/" target="_blank"
						   class="button-secondary">
							<?php esc_html_e( 'Learn More', 'kb-support' ); ?>
							<span class="dashicons dashicons-external"></span>
						</a>
					...
					<div class="content feature-section-item last-feature">
						<img
							src="<?php echo KBS_PLUGIN_URL . '/assets/images/screenshots/11-additional-agents-metabox.png' ?>"
				...
				<div class="feature-section wp-clearfix agent-notifications flex">

					<div class="video feature-section-item">
						<img
							src="<?php echo KBS_PLUGIN_URL . '/assets/images/screenshots/11-agent-notifications.png' ?>"
							alt="<?php __( 'Agent notifications', 'kb-support' ); ?>">
					</div>
	...
	public function getting_started_screen(){
		...
		<div class="wrap get-started row wpchill-about-row">
			<div class="wpchill-about__container">
				...
				<div class="feature-section wp-clearfix flex">
					...
					<div class="content feature-section-item last-feature">
						<img
							src="<?php echo KBS_PLUGIN_URL; ?>assets/images/screenshots/getting-started-ticket-article-search.png">
					</div>
				...
				<div class="feature-section wp-clearfix flex">
					...
					<div class="content feature-section-item display-options">
						<a href="https://kb-support.com/extensions/" target="_blank"
						   title="Extend KB Support with extensions">
							<img
								src="<?php echo KBS_PLUGIN_URL; ?>assets/images/screenshots/getting-started-extensions.jpg">
						</a>
					</div>
				...
				<div class="return-to-dashboard">
					...
					<a href="https://twitter.com/kbsupport_wp" class="twitter-follow-button" target="_blank"
					   data-show-count="false"><?php
						esc_html_e( 'Follow us @kbsupport_wp', 'kb-support' );
						?></a>
				</div>
			</div>
		</div>
	...
	public function get_welcome_header(){
		...
		?>
		<div class="row wpchill-about-row">
			<div class="wpchill-about__container">
				...
				<div class="wpchill-about-content">
					<?php $this->tabs(); ?>
				</div>
			</div>
		</div>
	...
	public function social_media_elements(){ ?>
		...
		<div class="social-items-wrap">
			...
			<iframe
				src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fkbsupport&amp;send=false&amp;layout=button&amp;width=100&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=220596284639969"
	...
	public function welcome(){
		...
		if ( !$upgrade ){ // First time install
			wp_safe_redirect( admin_url( 'index.php?page=kbs-getting-started' ) );
			exit;
		} else { // Update
			wp_safe_redirect( admin_url( 'index.php?page=kbs-about' ) );
			exit;
		}
	} // welcome
}
